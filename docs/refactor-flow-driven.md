...
- `save_review` / `save_foundation`：在章级审阅、短篇全文终审或长篇 `complete_book` 后判定 `book_complete`
...
- 设计总字数小于等于 30000 字，或用户明确要求短篇/单卷/小品/单案单冲突 → `architect_short`
- 设计总字数大于 30000 字，或用户明确要求长篇连载、多卷多弧、持续升级、长期关系张力、复杂世界/势力/资源线 → `architect_long`
