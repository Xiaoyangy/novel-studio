...
- `deal-paper-summry`: ok
- `fanqie-writing-flow`: ok
- `fanqie-novel-template`: ok
- `fanqie-baihe-short`: ok
- `fanqie-shuangnanzhu-short`: ok
- `fanqie-shuangwen-short`: ok
- `fanqie-western-fantasy-short`: ok
- `review`: ok
- `fanqie-legacy-prompts`: ok
