...
func (s *RuntimeStore) AcquirePipelineExecution(lock domain.PipelineExecutionLock) error {
	...
	switch lock.Mode {
	case domain.PipelineExecutionFoundation, domain.PipelineExecutionWorldTick, domain.PipelineExecutionOutlineAll, domain.PipelineExecutionPreplan, domain.PipelineExecutionProjectAll, domain.PipelineExecutionPromote:
