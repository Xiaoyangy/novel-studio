...
// Models 暴露内部 ModelSet，供外部 CLI 工具（如 --review-existing）直接调 Editor LLM。
// 注意：本访问器只用于"不参与 Coordinator 决策"的旁路调用；写入新章节等仍走 Resume()。
func (h *Host) Models() *bootstrap.ModelSet { return h.models }
...
// Snapshot 聚合 TUI 所需的运行状态，实现见 host_snapshot.go。
