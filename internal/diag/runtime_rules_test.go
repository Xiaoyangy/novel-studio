...
func TestRuntimeFindings_Classify(t *testing.T) {
	rc := RuntimeCapture{
		...
		EmptyToolCalls: []EmptyToolStat{
			{Agent: "coordinator", Tool: "novel_context", Count: 6, MaxRun: 6},
			{Agent: "coordinator", Tool: "subagent", Count: 9, MaxRun: 9}, // 只 novel_context 触发专门规则
		},
	...
	want := map[string]Severity{
		...
		"EmptyNovelContextLoop": SevWarning,
