...
type Progress struct {
	...
	POV               *POVState   `json:"pov,omitempty"`                 // 视角契约与按章 POV 历史（多 POV 长篇用）
	...
	// GenerationID identifies the active simulated canon. It is empty for older
	// projects. A simulation restart sets a new generation id so old completed
	// chapters are not mistaken for facts in the regenerated timeline.
