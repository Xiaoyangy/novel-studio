...
chapter_path=os.path.join(a.project,"chapters",f"{a.chapter:02d}.md")
body_sha256=""
if os.path.exists(chapter_path):
    body_sha256=hashlib.sha256(open(chapter_path,"rb").read()).hexdigest()
row={"chapter":a.chapter,"detector":a.detector,"mode":a.mode,"score":a.score,"verdict":a.verdict,"note":a.note,"body_sha256":body_sha256,"checked_at":time.strftime("%Y-%m-%dT%H:%M:%S")}
