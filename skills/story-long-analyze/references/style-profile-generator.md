...
>
> **输出**：`deconstruction-library/{书名}/文风.md`（模板见 [style-profile-protocol.md](style-profile-protocol.md)）。

## 6 步流程

### Step 1: 读拆文报告核心字段

读 `deconstruction-library/{书名}/拆文报告.md`，提取：
...
旧 `deconstruction-library/{书名}/` 没有文风文件时：
