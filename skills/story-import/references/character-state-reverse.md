...
| 输入文件 | 用途 |
|---------|------|
| `deconstruction-library/{书名}/角色/{角色名}.md` | 基本档案（身份、能力、动机、出场记录、成长弧线） |
| `deconstruction-library/{书名}/角色/角色关系.md` | 关键关系的当前/最终状态与演变轨迹 |
| `deconstruction-library/{书名}/章节/第N章_摘要.md` | 各章情节点（角色状态变化的时序证据） |
| `deconstruction-library/{书名}/剧情/*.md` | 角色弧线、阵营/身份转折、故事线汇总 |
