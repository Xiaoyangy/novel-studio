...
| 摊牌/亮真相 | 摊牌模式 | 信息是倾泻不是抽取：证据一件件砸，每件之间留对方的身体反应 |
| 当众撕破脸/打脸 | 公开对峙 | 先写观众再写对话：双方一半的话是演给旁人看的；观众反应反过来改变对话走向 |
| 拉拢/劝降/开条件 | 招揽模式 | 条件必须真的动人；写出主角真被说动的一瞬，拒绝才有分量 |
| 双方都在套话 | 双向试探 | 权力对称，每句话既是鱼饵也是盾牌；谁先问出真问题谁先暴露 |
| 关系断裂/割席 | 决裂模式 | 出口必须是"回不去了"的具象物：摘下的戒指、删掉的号码、还回的钥匙 |
| 道歉/和解 | 和解模式 | 禁止直说"对不起我错了"；用行动、旧梗、递东西承载歉意 |
| 报丧/告知失败 | 坏消息模式 | 写说的人怎么拖延、听的人怎么拒绝理解；坏消息本身放最短的一句 |
| 师父教导/传功 | 传承模式 | 设定预算从严：教的内容按需带出，重心放在两人关系和学错的过程 |
| 醉酒/重伤/濒死吐真言 | 失控真言 | 滤镜脱落但不逻辑清晰：真话是碎的、次序乱的、带悔意的 |
| 表面聊琐事底下有事 | 日常承重 | 只谈晚饭、天气、账单；真正的事一次都不许说破，全靠动作和停顿漏 |
| 三方以上议事 | 群议模式 | 写前给每人派系和议程；必须有一次倒戈或弃权改变风向 |
| 主角偷听/旁观 | 旁听模式 | POV 无法回应只能误读；听到一半被打断，带走错误结论 |
| 电话/消息/书信 | 隔媒介 | 没有表情动作拍，改用媒介拍：已读不回、打字又删、信纸折痕、门后脚步 |
| 威胁/敲诈 | 胁迫模式 | 与谈判的区别是不给对方留选择；压迫感来自平静和具体细节，不是咆哮 |
...
1. **对话即战术**：每句台词都是角色为拿到想要的东西采取的一步行动，不是信息陈述。战术受挫必须换战术——同一战术连用三回合就是水。
2. **没人直说想要什么**：直说欲望的台词只允许出现在情绪彻底破防的转折点上，一场戏最多一次。
3. **每回合必须改变四者之一**：信息、压力、关系温度、权力位置。四者都没变的回合直接删。
4. **每场必须翻转一个价值**：信任→怀疑、安全→危险、希望→绝望（或反向）。收场极性和开场一样的对话场，整场删掉或并入他场。
5. **权力至少易手一次**：开场占上风的一方，中途必须被抢走一次节奏；允许再抢回来，但不许全程静止。
6. **称谓是潜台词**：称呼漂移（敬称脱落、直呼其名、突然加回客气话）本身是一条潜台词线；一场戏里的称谓变化要设计，不要随机。

另有两条真实感规则：回答可以不接茬——答非所问、用问题回答问题、接前一句的错误重点，全程一问一答严丝合缝就是假；信息差要写三方——甲知道什么、乙知道什么、**读者**知道什么，读者比 POV 知道得多是戏剧反讽（替角色捏汗），知道得少是悬念。
...
- [ ] 价值翻转：这场对话结束时，是否有一个价值的极性和开场不同（信任/安全/希望/亲密/控制权）
- [ ] 权力易手：开场占上风的一方，中途是否被抢走过一次节奏
- [ ] 战术换挡：有没有角色同一说话策略连用三回合不换
- [ ] 称谓漂移：称呼变化是设计出来的潜台词，还是随机波动
- [ ] 观众效应：有第三方在场的对话，双方是否在演给旁人看；观众反应是否改变了对话走向
- [ ] 接茬检查：是否全程一问一答严丝合缝；至少要有一处答非所问、反问或接错重点
